    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                IndexNumber = GetIndexNumber(userId),
                BirthDay = GetBirthDay(userId),
        ...
        {
            return UserManager.FindById(id).FirstName;

        }
       
        private string GetLastName(string Id)
        {
            return UserManager.FindById(Id).LastName;
        }
        private string GetIndexNumber(string Id)
        {
            return UserManager.FindById(Id).IndexNumber;
        }
        private DateTime? GetBirthDay(string Id)
        {
            return UserManager.FindById(Id).BirthDay;
        }
        private byte[] GetUserPhoto(string Id)
        {
            return UserManager.FindById(Id).UserPhoto;
        }
        //
